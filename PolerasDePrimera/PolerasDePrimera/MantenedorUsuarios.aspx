<%@ Page Title="" Language="C#" MasterPageFile="~/RopaPrimera.Master" AutoEventWireup="true" CodeBehind="MantenedorUsuarios.aspx.cs" Inherits="PolerasDePrimera.MntenedorUsuarios" %>
    ...
    <!--======== START CLIENT DETAILS FORM ========-->
            <div class="c_panel margin-top-50">
                ...
                <div class="c_title bg-info padding-top-20 padding-bottom-20">
                    <h2><span class="font-bold">Ingrese usuario</span></h2>
                ...
                <div class="c_content">
                   ...
                   <form class="form-horizontal">
                        <div class="form-group">
                            <label for="client-name" class="col-sm-2 control-label">Nombre*</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="client-name" placeholder="Nombre">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="company-name" class="col-sm-2 control-label">Apellido*</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="company-name" placeholder="Apellido">
                            </div>
                        </div>
                        <div class="form-group">
