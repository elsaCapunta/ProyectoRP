<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="PolerasDePrimera._default" %>
                ...
                <div class="form-body bg-white padding-20">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-header bg-white padding-10 text-center">
                                <h2><strong>Ingrese su cuenta</strong></h2>
                            </div>

                            <form action="../index.html">
                                <div class="inner-addon right-addon margin-bottom-15">
                                    <i class="fa fa-envelope"></i>
                                    <input id="txtUsuario" runat="server" type="text" class="form-control" placeholder="Email" />
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <asp:Button ID="btnIngresar" OnClick="btnIngresar_Click" runat="server" Text="Ingresar" CssClass="btn btn-green btn-raised btn-flat" />
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <p><a href="#">Presione aquí para recuperar su contraseña</a></p>
                        </div>
                    </div>
